...
class ReportOrchestrator:
    ...
    async def _run_phase1(
        ...
        if df is not None:
            ...
            # Build profile from UDM metadata
            data_profile = DataProfile(
                schema_metadata={
                    "columns": {col: {"dtype": "unknown"} for col in udm.cleaned_columns},
                    "row_count": 0,
            ...
            "charts": [
                {
                    ...
                    "type": r.chart_hint.value if hasattr(r.chart_hint, 'value') else str(r.chart_hint),
